            ...
            ?>
                ...
                <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                        <div class="notify bg-light-primary text-primary"><ion-icon name="cart-outline"></ion-icon></div>
                        <div class="flex-grow-1">
                            <h6 class="msg-name"><?= $notification->title; ?><span class="msg-time float-end time-ago" data-time="<?= strtotime($notification->created_at); ?>"><?= $timeAgo; ?></span></h6>
