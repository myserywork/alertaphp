            ...
            <nav class="navbar navbar-expand gap-3">
                ...
                <div class="top-navbar-right ms-auto">
                    <ul class="navbar-nav align-items-center">
                       <?php $this->load->view('dashboard/top_header/search_view.php'); ?>
                       <?php $this->load->view('dashboard/top_header/color_toggle_view.php'); ?>
                       <?php $this->load->view('dashboard/top_header/hotmenu_dropdown_view'); ?>
                       <?php $this->load->view('dashboard/top_header/notifications_dropdown_view'); ?>
                       <?php $this->load->view('dashboard/top_header/user_dropdown_view'); ?>
                    </ul>
               </div>
           </nav>
</header>