...
$config['sendgrid_from_email'] = 'sendeexampexample@example.com';
$config['sendgrid_from_name'] = 'Your Name';


$config['base_url'] = getCurrentBaseUrl();
...
function getCurrentBaseUrl()
{
    ...
    // You can append additional path segments if needed
...
|
*/
$config['encryption_key'] = 't6w9z$C&F)J@NcRfUjXnZr4u7x!A%D*G-KaPdSgVkYp3s5v8y/B?E(H+MbQeThWm';
