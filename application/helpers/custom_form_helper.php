...
if (!function_exists('generateForm')) {
    function generateForm($subject, $formData, $fields, $categoryId, $reference) {
        ...
        $output .= '            var url = "'.base_url('customfields/save').'";';
    ...
    function generate_form_field($field, $formData) {
        ...
        switch ($field->type) {
            case 'text':
                ...
                $output .= '<input type="text" class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" value="'.$value.'" '.$required.'>';
                $output .= '</div>';
                return $output;
            case 'textarea':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
                $output .= '<textarea class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" '.$required.'>'.$value.'</textarea>';
                $output .= '</div>';
                return $output;
            case 'select':
                $output = '<div class="form-group">';
            ...
            case 'date':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
                $output .= '<input type="date" class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" value="'.$value.'" '.$required.'>';
                $output .= '</div>';
                return $output;
            case 'datetime':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
                $output .= '<input type="datetime-local" class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" value="'.$value.'" '.$required.'>';
                $output .= '</div>';
                return $output;
            case 'file':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
                $output .= '<input type="file" class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" '.$required.'>';
                $output .= '</div>';
                return $output;
            case 'multiselect':
                $output = '<div class="form-group">';
                ...
                return $output;
            case 'hidden':
                $output = '<input type="hidden" name="'.$field->name.'#'.$field->id.'" value="'.$value.'">';
                return $output;
            case 'password':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
            ...
            case 'email':
                $output = '<div class="form-group">';
                $output .= '<label for="'.$field->name.'#'.$field->id.'">'.$field->display.'</label>';
                $output .= '<input type="email" class="form-control" id="'.$field->name.'#'.$field->id.'" name="'.$field->name.'#'.$field->id.'" placeholder="'.$field->display.'" value="'.$value.'" '.$required.'>';
                $output .= '</div>';
                return $output;
            default:
                return '';
...
if (!function_exists('getViewTable')) {
...
if (!function_exists('getViewTableMany')) {
