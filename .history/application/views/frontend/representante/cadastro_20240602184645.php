            ...
            $("#formCadastro").submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            $('#submitBtn').hide();
                            $('<div class="alert alert-success mt-3">Cadastro realizado com sucesso! Você será redirecionado para mais detalhes.</div>').insertAfter('#submitBtn');
                        } else {
                            $('<div class="alert alert-danger mt-3">' + data.message + '</div>').insertAfter('#submitBtn');
                        }
                    },
                    error: function () {
                        $('<div class="alert alert-danger mt-3">Erro ao realizar seu cadastro</div>').insertAfter('#submitBtn');
                    }
                });
            });
        });
