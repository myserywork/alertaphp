                        ...
                        <div class="flex-box weekDays">
                            ...
                            <div class="input-content">
                                <div class="sc-iCKXBC daYHuF">
                                    <div class="list-radios">
                                        <label for="period-1">
                                            <input id="period-1" name="dota[]" class="days" type="radio" value="manha">Manhã
                                        </label>
                                        <label for="period-2">
                                            <input id="period-2" name="dota[]" class="days" type="radio" value="noite">Tarde
                                        </label>
                                       
                                        <label for="period-3">
                                            <input id="period-3" name="dota[]" class="days" type="radio" value="noite">Noite
                                        </label>
                                    </div>
                                </div>
                            </div>
