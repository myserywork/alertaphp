...
<body>
    ...
    <div class="bottom-nav">
        <a href="#overview" onclick="showTab('overview')" class="active"><i class="fas fa-info-circle"></i></a>
        <a href="#meus-dados" onclick="showTab('meus-dados')"><i class="fas fa-user"></i></a>
        <a href="#avaliacoes" onclick="showTab('avaliacoes')"><i class="fas fa-clipboard-list"></i></a>
        <a href="#graficos" onclick="showTab('graficos')"><i class="fas fa-chart-line"></i></a>
        <a href="#medicacoes" onclick="showTab('medicacoes')"><i class="fas fa-pills"></i></a>
        <a href="#prontuarios" onclick="showTab('prontuarios')"><i class="fas fa-file-medical"></i></a>
    </div>
