...
<body>
    <div class="container">
        ...
        <div id="medicacoes" class="tab-content">
            <?php $this->load->view('frontend/user/medications', array('medicacoes' => $medicacoes, 'paciente' => $paciente)); ?>
        </div>
        <div id="prontuarios" class="tab-content">
            <?php $this->load->view('frontend/user/prontuarios', array('prontuarios' => $prontuarios, 'paciente' => $paciente)); ?>
        </div>
        <div id="alertas" class="tab-content">
            <?php $this->load->view('frontend/user/alertas', array('alertas' => $alertas, 'paciente' => $paciente)); ?>
        </div>
    </div>
    <script>
