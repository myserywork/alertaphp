...
<body>
    ...
    <div class="bottom-nav">
        <a href="#overview" onclick="showTab('overview')" class="active"><i class="fas fa-info-circle"></i><br>Overview</a>
        <a href="#meus-dados" onclick="showTab('meus-dados')"><i class="fas fa-user"></i><br>Meus Dados</a>
        <a href="#avaliacoes" onclick="showTab('avaliacoes')"><i class="fas fa-clipboard-list"></i><br>Avaliações</a>
        <a href="#graficos" onclick="showTab('graficos')"><i class="fas fa-chart-line"></i><br>Gráficos</a>
        <a href="#medicacoes" onclick="showTab('medicacoes')"><i class="fas fa-pills"></i><br>Medicações</a>
        <a href="#prontuarios" onclick="showTab('prontuarios')"><i class="fas fa-file-medical"></i><br>Prontuários</a>
    </div>
