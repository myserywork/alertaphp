...
<body>
    <div class="mood-container">
        ...
        <button class="save-button">Salvar Humor</button>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.mood-meter i').forEach(icon => {
                icon.addEventListener('click', function() {
                    selectMood(icon.getAttribute('data-mood'), icon.getAttribute('data-mood-value'), icon);
                });
            });

            document.querySelector('.save-button').addEventListener('click', saveMood);
        });
