...
<head>
    ...
    <style>
        ...
        .mood-meter span:hover {
            transform: scale(1.2);
        }
        .mood-meter span.selected {
            transform: scale(1.4);
            color: #27ae60;
        }
        .save-button {
...
<body>
    <div class="mood-container">
        ...
        <div class="mood-meter">
            <span data-mood="Feliz" onclick="selectMood(this)"><img src="https://twemoji.maxcdn.com/v/latest/svg/1f600.svg" alt="Feliz"></span>
            <span data-mood="Triste" onclick="selectMood(this)"><img src="https://twemoji.maxcdn.com/v/latest/svg/1f61e.svg" alt="Triste"></span>
            <span data-mood="Neutro" onclick="selectMood(this)"><img src="https://twemoji.maxcdn.com/v/latest/svg/1f610.svg" alt="Neutro"></span>
            <span data-mood="Irritado" onclick="selectMood(this)"><img src="https://twemoji.maxcdn.com/v/latest/svg/1f621.svg" alt="Irritado"></span>
            <span data-mood="Cansado" onclick="selectMood(this)"><img src="https://twemoji.maxcdn.com/v/latest/svg/1f62b.svg" alt="Cansado"></span>
        </div>
    ...
    <script>
        ...
        function selectMood(element) {
            document.querySelectorAll('.mood-meter span').forEach(icon => icon.classList.remove('selected'));
