...
<body>
    <div class="mood-container">
        ...
        <div class="mood-meter">
            <i class="fas fa-grin-beam" data-mood="Feliz" style="color: #FFD700;" onclick="selectMood(this)"></i>
            <i class="fas fa-frown" data-mood="Triste" style="color: #1E90FF;" onclick="selectMood(this)"></i>
            <i class="fas fa-meh" data-mood="Neutro" style="color: #808080;" onclick="selectMood(this)"></i>
            <i class="fas fa-angry" data-mood="Irritado" style="color: #FF4500;" onclick="selectMood(this)"></i>
            <i class="fas fa-tired" data-mood="Cansado" style="color: #8B4513;" onclick="selectMood(this)"></i>
        </div>
