    ...
    <div class="container">
        ...
        <div id="overview" class="tab-content active">
            ...
            <div class="mood-meter">
                <i class="material-icons" onclick="selectMood(this, 'Feliz')">sentiment_very_satisfied</i>
                <i class="material-icons" onclick="selectMood(this, 'Triste')">sentiment_dissatisfied</i>
                <i class="material-icons" onclick="selectMood(this, 'Neutro')">sentiment_neutral</i>
                <i class="material-icons" onclick="selectMood(this, 'Irritado')">sentiment_very_dissatisfied</i>
                <i class="material-icons" onclick="selectMood(this, 'Cansado')">sentiment_very_tired</i>
            </div>
                ...
                <ul id="medications-list">
                    <?php foreach ($medicacoes as $medicacao): ?>
                        <li data-id="<?= $medicacao->id ?>">
                            ...
                            <div class="actions">
                                <button onclick="editMedication(<?= $medicacao->id ?>)"><i class="material-icons">edit</i></button>
                                <button onclick="deleteMedication(<?= $medicacao->id ?>)"><i class="material-icons">delete</i></button>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
                ...
                <ul id="records-list">
                    <?php foreach ($prontuarios as $prontuario): ?>
                        <li data-id="<?= $prontuario->id ?>">
                            ...
                            <div class="actions">
                                <button onclick="editRecord(<?= $prontuario->id ?>)"><i class="material-icons">edit</i></button>
                                <button onclick="deleteRecord(<?= $prontuario->id ?>)"><i class="material-icons">delete</i></button>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
