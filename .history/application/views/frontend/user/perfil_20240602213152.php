...
<body>
    <div class="container">
        ...
        <div class="tabs">
            <button onclick="showTab('overview')" class="active"><i class="ion-ios-information-circle-outline"></i> Overview</button>
            <button onclick="showTab('meus-dados')"><i class="ion-ios-person-outline"></i> Meus Dados</button>
            <button onclick="showTab('avaliacoes')"><i class="ion-ios-list-box-outline"></i> Avaliações</button>
            <button onclick="showTab('graficos')"><i class="ion-ios-stats-outline"></i> Gráficos</button>
            <button onclick="showTab('medicacoes')"><i class="ion-ios-medkit-outline"></i> Medicações</button>
            <button onclick="showTab('prontuarios')"><i class="ion-ios-paper-outline"></i> Prontuários</button>
        </div>
    ...
    <div class="bottom-nav">
        <a href="#overview" onclick="showTab('overview')" class="active"><i class="ion-ios-information-circle-outline"></i><br>Overview</a>
        <a href="#meus-dados" onclick="showTab('meus-dados')"><i class="ion-ios-person-outline"></i><br>Meus Dados</a>
        <a href="#avaliacoes" onclick="showTab('avaliacoes')"><i class="ion-ios-list-box-outline"></i><br>Avaliações</a>
        <a href="#graficos" onclick="showTab('graficos')"><i class="ion-ios-stats-outline"></i><br>Gráficos</a>
        <a href="#medicacoes" onclick="showTab('medicacoes')"><i class="ion-ios-medkit-outline"></i><br>Medicações</a>
        <a href="#prontuarios" onclick="showTab('prontuarios')"><i class="ion-ios-paper-outline"></i><br>Prontuários</a>
    </div>
    <script>
