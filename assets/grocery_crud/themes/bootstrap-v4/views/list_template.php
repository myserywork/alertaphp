...
<script type='text/javascript'>
    ...
    border-radius: 1%;
"> 
                <div class="table-label" style="background-color:transparent !important;,color:black !important;">
                    <div class="floatL l5">
                    ...
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                            ...
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <a class="btn btn-secondary t5 gc-export" data-url="<?php echo $export_url; ?>" href="javascript:;">
                                        <i class="el el-share floatL t3" style="margin-top:3px;"></i>
                                ...
                                <?php if(!$unset_print) { ?>
                                    <a class="btn btn-secondary t5 gc-print" data-url="<?php echo $print_url; ?>" href="javascript:;">
                                        <i class="el el-print floatL t3 " style="margin-top:3px;"></i>
                                        <span class="hidden-xs floatL l5">
                                           Imprimir
                                        </span>
                                        <div class="clear"></div>
                        ...
                        <div class="scroll-if-required">
        					...
        					<thead>
        						...
        						<tr class="filter-row hidden gc-search-row">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <input
                                                ...
                                                placeholder="Buscar <?= $column->display_as;?>"
                                                ...
                                                <div class="btn-group floatR t20 l10 settings-button-container">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="javascript:void(0)" class="clear-filtering dropdown-item">
                                                            <i class="el el-eraser"></i> Apagar filtros
                                                        </a>
                                                    </div>
                                                </div>
